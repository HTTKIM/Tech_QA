...
st.markdown('<div class="custom-sub-list">예시) EPS실, 피트실 등 법령에 없는 단어는 답변이 불가합니다.', unsafe_allow_html=True)
st.markdown('<div class="custom-sub-list">예시) 방화구획, 피난계단, 옥내소화전 등 법령에 있는 단어는 검색 가능', unsafe_allow_html=True)
